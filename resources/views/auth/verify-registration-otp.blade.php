...
<!-- BAB'S RESTO – Verify Registration Email Page -->
<style>
...
<div class="auth-wrap" role="main">
    ...
    <div class="left-side" aria-hidden="true">
        ...
        <div class="left-inner">
            ...
            <div class="animated-slogan">
                ...
                <span class="word accent">email</span>
            </div>

            <!-- Description -->
            <p class="desc">
                We've sent a 6-digit verification code to your email address. Enter it below to activate your account before signing in.
            </p>
    ...
    <div class="right-side">
        <div class="reset-card" role="region" aria-labelledby="reset-heading">
            ...
            <h2 id="reset-heading">Verify Your Email</h2>
            <p class="reset-sub">Code sent to <strong>{{ $email }}</strong></p>
            ...
            <!-- ── Form ── -->
            <form method="POST" action="{{ route('register.otp.verify.store') }}" id="verifyForm" novalidate>
                @csrf
                ...
                <!-- Submit button -->
                <button type="submit" id="submitBtn" class="btn-submit" aria-label="Verify Email">
                    <span class="spinner" id="spinner" aria-hidden="true"></span>
                    <span id="btnLabel"><i class="fas fa-check" aria-hidden="true"></i>&nbsp; Verify Email</span>
                </button>
            ...
            <form method="POST" action="{{ route('register.otp.resend') }}">
                @csrf
                <button type="submit" class="btn-back" aria-label="Resend verification code">
