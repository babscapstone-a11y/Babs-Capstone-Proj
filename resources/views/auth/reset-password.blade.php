...
<!-- BAB'S RESTO – Set New Password Page (token/email link flow) -->
<style>
    ...
    *{box-sizing:border-box}
    ...
    /* ── Error notification (invalid/expired link) ── */
    .error-note{
    ...
    .error-note .error-icon{
        color:var(--primary);font-size:1.1rem;flex-shrink:0;margin-top:.05rem;
    }
    .error-note .error-text{
        color:#991B1B;font-size:.88rem;line-height:1.5;font-weight:500;
    }
...
<div class="auth-wrap" role="main">
    ...
    <div class="left-side" aria-hidden="true">
        ...
        <div class="left-inner">
            ...
            <!-- Description -->
            <p class="desc">
                Your request was approved. Set a new password below to regain access to your account.
            </p>
    ...
    <div class="right-side">
        <div class="reset-card" role="region" aria-labelledby="reset-heading">
            ...
            @error('email')
                <div class="error-note" role="alert" aria-live="polite">
