...
@section('title', 'Special Discount Requests')
@section('page-title', 'Special Discount Requests')
...
@section('breadcrumb')
    ...
    <span class="breadcrumb-sep">/</span>
    <span>Special Discount Requests</span>
@endsection
...
<style>
    ...
    .amount-cell { font-weight: 800; color: var(--primary); font-size: .9rem; }
...
{{-- Filter Bar --}}
<form method="GET" action="{{ route('special-discount-requests.index') }}" class="filter-bar anim-2" id="liveFilterForm">
    <div class="search-wrap">
        <input type="text" id="search" name="search" class="search-input"
               placeholder="Search by order number, request number, or cashier username…"
    ...
    <a href="{{ route('special-discount-requests.index') }}" class="btn-reset"><i class="fas fa-rotate-left"></i> Reset</a>
</form>

{{-- Table --}}
<div class="table-card anim-3" id="results">
    @include('special-discount-requests._results', ['specialDiscountRequests' => $specialDiscountRequests])
</div>
...
document.addEventListener('DOMContentLoaded', function () {
    LiveTable.init({
        ...
        url: '{{ route('special-discount-requests.index') }}',
